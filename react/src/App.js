                        ...
                        {customers.map((person) => (
                            <li key={person.id} className="flex justify-between gap-x-6 py-5">
                                ...
                                <div className=" sm:flex sm:flex-row sm:items-end">
                                    <button
                                        type="button"
                                        className="mx-2 rounded-md bg-purple-500 px-2 py-1 text-sm font-light text-white shadow-sm hover:bg-purple-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple-500"
                                    >
                                        Edit
                                    </button>
                                    <button
